...
export default function DestinationsCreate() {
    ...
    const handleSubmit = (e) => {
        ...
        if (imageFile) {
            ...
            router.post("/admin/destinations", form);
        }
    };
                    ...
                    <div className="xl:col-span-2 space-y-6">
                        ...
                        <div className="rounded-2xl border border-sand bg-white p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="text-xs text-forest-muted block mb-1.5">Alamat (opsional)</label>
                                ...
                                <p className="text-[0.65rem] text-forest-muted/60 italic">
                                    Jarak dari pusat kota dan durasi perjalanan akan dihitung otomatis.
                                </p>
                            </div>
                        </div>
                    </div>

                    {/* Right column — image + 3D (layout tetap) */}
